...
class OFResPartner(models.Model):
    ...
    def action_open_wizard_plan_intervention(self):
        ...
        # In case of the default task is not set, we start the wizard without the pre-search
        if not default_planning_task_id:
        ...
        slots_display_mode = ir_values_obj.get_default('of.intervention.settings', 'slots_display_mode')
