...
class AccountMove(models.Model):
    ...
    def of_recompute_last_payment_schedule(self):
        for move in self:
            # Only draft and sent moves can have their payment schedule recomputed totally
    ...
    def _get_payment_schedule_needs_recompute(self):
        ...
        def filter_needs_recompute(move):
            return (
                (move.invoice_payment_term_id and not move.of_payment_schedule_ids)
                or move.of_payment_schedule_ids
                and float_compare(
