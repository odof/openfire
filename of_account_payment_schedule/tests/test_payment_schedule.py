...
class TestOFAccountMovePaymentSchedule(TestOFAccountCommon):
    def setUp(self):
        super().setUp()
    ...
    def test_02_payment_schedule_update(self):
        ...
        invoice = self.env["account.move"].new(self.move_vals)
        invoice.invoice_payment_term_id = self.payment_term_15days
        ...
        invoice.invoice_payment_term_id = self.payment_term_30_30_40
        invoice._compute_of_payment_schedule_ids()
