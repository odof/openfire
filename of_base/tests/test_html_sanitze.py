...
class TestOFHTMLSanitize(TestOFBaseCommon):
    ...
    def test_01_html_sanitize_img(self):
        ...
        with mock.patch(
            ...
            comment = f'<p>Test html sanitize</p><img src="data:image/png;base64,{self.openfire_b64}"/>'  # noqa
    ...
    def test_02_html_sanitize_img(self):
        ...
        with mock.patch(
            ...
            self.assertEqual(
                partner.comment,
                markupsafe.Markup(
                    f'<p>Test html sanitize</p><img src="data:image/png;base64,{self.openfire_b64}">'  # noqa
                ),
            )
