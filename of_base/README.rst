...
* Surcharge du code standard Odoo pour gérer l'addition de groupes dans les attributs champs de la vue XML.
...
* Ajout d'un composant pour afficher la version actuelle de l'application.
  ...
  - pour ce faire **la version** doit être définie dans le **fichier `.openfire-version`** dans le répertoire racine **contenant `odoo` et le repo `openfire`**.
