...
def post_init_hook(cr, registry):
    ...
    # Patch user_has_groups method
    if not hasattr(BaseModel, 'user_has_groups_original'):
        BaseModel.user_has_groups_original = BaseModel.user_has_groups
    BaseModel._patch_method('user_has_groups', user_has_groups)

    # Patch _update_user_groups_view method
    if not hasattr(GroupsView, 'update_user_groups_view_original'):
        GroupsView.update_user_groups_view_original = GroupsView._update_user_groups_view
    GroupsView._patch_method('_update_user_groups_view', _update_user_groups_view)

    # Patch onchange_parent_id method
    if not hasattr(Partner, 'onchange_parent_id_original'):
        Partner.onchange_parent_id_original = Partner.onchange_parent_id
    Partner._patch_method('onchange_parent_id', onchange_parent_id)
...
def uninstall_hook(cr, registry):
    ...
    delattr(BaseModel, 'user_has_groups_original')
    delattr(GroupsView, 'update_user_groups_view_original')
    delattr(Partner, 'onchange_parent_id_original')
