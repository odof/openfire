...
class OFDatastoreProductReference(models.AbstractModel):
    ...
    _description = "Datastore Product Reference"
    ...
    def _ds_handle_product_id(self, vals):
        ...
        # sur les lignes de commandes et de factures, l'uom est encore en négative on va donc mettre celle qui vient du
        # produit, une fois qu'il est crée ajout pour les lignes de commandes
    ...
    def _ds_handle_product_ids(self, vals):
        ...
        # On appelle of_ds_import() ici plutôt que dans le for pour éviter d'appeler trop souvent la base centralisée
