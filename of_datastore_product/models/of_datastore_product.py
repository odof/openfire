...
#                        server_address = "http://%s:6161" % (ip_address,) # Sur openfire.fr le port 6161 est utilisé car la v9 occupe déjà le 8069
    ...
    @api.multi
    def of_datastore_get_model(self, client, model_name):
        self.ensure_one()
    ...
    def _compute_categ_ids(self):
        ...
        try:
            ...
            for supplier in self:
                ...
                ds_note_obj = self.of_datastore_get_model(client, 'of.import.note')
...
class ProductProduct(models.Model):
    ...
    def name_search(self, name='', args=None, operator='ilike', limit=100):
        ...
        brands = brand_obj.search(['prefix', 'in', prefixes])
        domain = brands and [('brand_id', 'in', brands._ids)] or []
