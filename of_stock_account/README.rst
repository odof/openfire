...
* Modification de la methode de cout pour l'uniformiser entre toutes les sociétés (si le module of_base_multicompany est installé)
...
* Ajout d'un champ "Cout théorique" qui correspond au coût calculé par application des règles définies dans la marque
