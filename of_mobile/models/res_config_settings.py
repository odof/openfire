...
class ResConfigSettings(models.TransientModel):
    ...
    of_mobile_can_create_additional_sale = fields.Boolean(
        string="Can create additional sale from an intervention",
        related='company_id.of_mobile_can_create_additional_sale',
        readonly=False,
    )
