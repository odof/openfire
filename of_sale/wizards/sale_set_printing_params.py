...
class OFSaleWizardSetPrintingParams(models.TransientModel):
    ...
    pdf_customer_signature = fields.Boolean(
        ...
        help="If checked, displays the customer signature insert at the bottom of the quote on the right")
    pdf_vendor_signature = fields.Boolean(
        string="Salesman signature", default=False,
        help="If checked, displays the salesman signature insert at the bottom of the estimate on the left")
