...
class SaleOrder(models.Model):
    ...
    def _amount_all(self):
        ...
        # Forcer le recalcul du cache sur les lignes en cours de création car le total ne change parfois qu'à
        # la sauvegarde. Or on veut que ce soit toujours recalculé (notamment pour l'échéancier)
