...
class OFPlanningInterventionLineMixin(models.AbstractModel):
    """Mixin class for lines linked to interventions that can be invoiced. Avoids code duplication between
    `of_planning.of.planning.intervention.line` and `of_equipment.of.calendar.event.equipment.link.line`.
    """
