...
class OFPlanningInterventionLine(models.Model):
    ...
    currency_id = fields.Many2one(compute="_compute_currency_id", related=False)
    ...
    def _compute_qty_invoiced(self):
        for line in self:
            # Take Invoice/Refund lines into account to compute the invoiced quantity
            invoice_lines = line.invoice_line_ids.filtered(lambda il: il.move_type == "out_invoice")
