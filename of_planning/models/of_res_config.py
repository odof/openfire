...
class OfInterventionSettings(models.TransientModel):
    ...
    def set_color_bg_creneaux_dispo_defaults(self):
        return self.env['ir.values'].sudo().set_default('of.intervention.settings', 'color_bg_creneaux_dispo', self.color_bg_creneaux_dispo)

    @api.multi
    def set_color_ft_creneaux_dispo_defaults(self):
        return self.env['ir.values'].sudo().set_default('of.intervention.settings', 'color_ft_creneaux_dispo', self.color_ft_creneaux_dispo)

    @api.multi
    def set_duree_min_creneaux_dispo_defaults(self):
        return self.env['ir.values'].sudo().set_default('of.intervention.settings', 'duree_min_creneaux_dispo', self.duree_min_creneaux_dispo)

    @api.multi
    def set_color_bg_creneaux_indispo_defaults(self):
        return self.env['ir.values'].sudo().set_default('of.intervention.settings', 'color_bg_creneaux_indispo', self.color_bg_creneaux_indispo)
