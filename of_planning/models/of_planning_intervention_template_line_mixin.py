...
class OFPlanningInterventionTemplateLineMixin(models.AbstractModel):
    """Abstract model for intervention template's line mixin in order to be inherited by other models to
    avoid code duplication. (e.g. `of_planning.of.intervention.template.line` and
    `of_equipment.of.equipment.intervention.report.template.line`)
    """

    _name = "of.planning.intervention.template.line.mixin"
    _description = "Intervention template's line mixin"
