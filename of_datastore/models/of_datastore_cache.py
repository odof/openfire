...
class DS_CACHE:
    ...
    """
    C'est ici que l'on met en place le ds_cache, c'est le même cache utilisé par Odoo
    Il reste juste persistant jusqu'à la prochaine mise à jour de module of_datastore
    ou au démarrage d'odoo
    """
    ...
    """
    Les méthodes suivantes permettent de stocker dans le ds_cache
    les champs disponibles sur un objet distant pour ne pas redemander
    à la base distante à chaque besoin
    """
    ...
    """
    Les méthodes suivantes permettent de savoir si un recordset est déjà prefetch
    dans le ds_cache, pour éviter des nouveaux appels à la base distante
    """
