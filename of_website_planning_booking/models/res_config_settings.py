    ...
    def _compute_of_booking_opened_day_ids(self):
        ...
        for setting in self:
            if setting.of_booking_company_specific:
                ...
                if setting.of_booking_opened_day_ids_str:
    ...
    def _inverse_of_booking_opened_day_ids(self):
        for setting in self:
            if setting.of_booking_company_specific:
                ...
                if setting.of_booking_opened_day_ids:
    ...
    def _compute_of_booking_employee_ids(self):
        ...
        for setting in self:
            if setting.of_booking_company_specific:
                ...
                if setting.of_booking_employee_ids_str:
    ...
    def _inverse_of_booking_employee_ids(self):
        for setting in self:
            if setting.of_booking_company_specific:
                ...
                if setting.of_booking_employee_ids:
    ...
    def _compute_of_booking_terms_file(self):
        for setting in self:
            if setting.of_booking_company_specific:
                ...
                setting.of_booking_terms_filename = setting.company_id.of_booking_terms_file
            else:
