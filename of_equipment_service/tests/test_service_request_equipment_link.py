...
class TestOFServiceRequest(TestOFEquipmentServiceCommon):
    ...
    def test_03_create_service_request_with_equipment_manual(self):
    ...
    def test_04_create_service_request_with_equipment_wizard(self):
    ...
    def test_05_service_request_compute_duration(self):
