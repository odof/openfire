...
class CalendarEvent(models.Model):
    ...
    def _handle_equipments_change(self, saved_equipment_links_by_event, vals):
        ...
        if links_action["removed"]:
            self._handle_equipment_changes_removed_links(saved_equipment_links_by_event, links_action["removed"])
        ...
        if updated_links:
            for data in updated_links:  # [{"link": link, "old_values": old_values}, ...]
                ...
                if service_request := event_equipment_lnk.event_id.of_request_id:
                    ...
                    request_equipment_lnk._post_request_message(data["old_values"], new_values)
        if removed_links:
    ...
    def _handle_equipment_changes_removed_links(self, saved_equipment_links_by_event, removed_links):
