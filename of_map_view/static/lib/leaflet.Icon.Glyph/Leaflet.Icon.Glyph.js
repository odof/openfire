/*
 * this content has been edited by Gael FRASSON working at OpenFire at the time. 
 *
 */
...
L.Icon.Glyph = L.Icon.extend({
	options: {
		...
		shadowSize: [41, 41],
		shadowAnchor: [12, 41],
		shadowUrl: '/of_map_view/static/lib/leaflet-1.0.3/images/marker-shadow.png',
...
// 		bgPos: (Point)
		...
		glyph: 'home',
		glyphColor: 'white',
		glyphSize: '14px',	// in CSS units
		glyphAnchor: [6, -8]	// In pixels, counting from the corner top left of the image.
	},
	...
	_createGlyph: function() {
		...
		span.id = 'glyph_'+this.options.id;

		if (textContent) {
			span.innerHTML = textContent;
			span.style.display = 'inline-block';
		}
		//console.log('glyph span: ',span);
