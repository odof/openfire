...
# See LICENSE file for full copyright and licensing details.
{
    ...
    Pour ce faire, dans l'étiquette que vous voulez utiliser > Onglet Advance > cliquer sur "Add sidebar button".
    ...
    Je choisis le nombre de copies de chaque ligne et les lignes à imprimer et clique sur "PRINT".
