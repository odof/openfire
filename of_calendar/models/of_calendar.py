...
class HREmployee(models.Model):
    ...
    def get_intersection_segments(self, segments_emp_1, segments_emp_2):
        ...
        # OK! on a une liste de segments avec 2 horaires_dict dans chaque.
        # maintenant on fusionne les horaires_dict pour garder leur intersection
...
class Meeting(models.Model):
    ...
    of_lieu_company_id = fields.Many2one("res.company", string=u"(Précisez)")
    ...
    of_color_partner_id = fields.Many2one("res.partner", "Partner whose color we will take",
                                          compute='_compute_color_partner', store=False)
    of_geo_lat = fields.Float(string='Geo Lat', digits=(8, 8), group_operator=False, help="latitude field",
                              compute="_compute_geo", store=False, search='_search_lat')
    of_geo_lng = fields.Float(string='Geo Lng', digits=(8, 8), group_operator=False, help="longitude field",
                              compute="_compute_geo", store=False, search='_search_lng')
