odoo.define('of_survey.session_manage', function (require) {
'use strict';

var publicWidget = require('web.public.widget');
var OFSurveyPreloadImageMixin = require('of_survey.preload_image_mixin');
var OFSurveySessionChart = require('of_survey.session_chart');
var OFSurveySessionTextAnswers = require('of_survey.session_text_answers');
var OFSurveySessionLeaderBoard = require('of_survey.session_leaderboard');
var core = require('web.core');
var _t = core._t;

publicWidget.registry.OFSurveySessionManage = publicWidget.Widget.extend(OFSurveyPreloadImageMixin, {
    ...
    */
    _nextQuestion: function (goBack) {
        ...
        var nextQuestionPromise = this._rpc({
            route: _.str.sprintf('/of_survey/session/next_question/%s', self.surveyAccessToken),
            params: {
                'go_back': goBack,
            }
    ...
    _refreshResults: function () {
        ...
        return this._rpc({
            route: _.str.sprintf('/of_survey/session/results/%s', self.surveyAccessToken)
     ...
     *
     * see OFSurveySessionChart widget doc for more information.
     *
     */
    _setupChart: function () {
        ...
        if (!this.isStartScreen && this.showBarChart) {
            this.resultsChart = new OFSurveySessionChart(this, {
     ...
     * see OFSurveySessionLeaderBoard widget doc for more information.
     *
     */
    _setupLeaderboard: function () {
        ...
        if (this.isScoredQuestion || this.isLastQuestion) {
            this.leaderBoard = new OFSurveySessionLeaderBoard(this, {
...
return publicWidget.registry.OFSurveySessionManage;
