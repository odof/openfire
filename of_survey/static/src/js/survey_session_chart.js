odoo.define('of_survey.session_chart', function (require) {
'use strict';

var publicWidget = require('web.public.widget');
var SESSION_CHART_COLORS = require('of_survey.session_colors');

publicWidget.registry.OFSurveySessionChart = publicWidget.Widget.extend({
...
return publicWidget.registry.OFSurveySessionChart;
