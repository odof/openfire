odoo.define('of_survey.session_text_answers', function (require) {
'use strict';
...
publicWidget.registry.OFSurveySessionTextAnswers = publicWidget.Widget.extend({
    ...
    updateTextAnswers: function (inputLineValues) {
        ...
        inputLineValues.forEach(function (inputLineValue) {
            if (!self.answerIds.includes(inputLineValue.id) && inputLineValue.value) {
                ...
                var $textAnswer = $(QWeb.render('of_survey.survey_session_text_answer', {
                    value: textValue,
...
return publicWidget.registry.OFSurveySessionTextAnswers;
