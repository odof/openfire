odoo.define('of_survey.quick.access', function (require) {
'use strict';

var publicWidget = require('web.public.widget');

publicWidget.registry.OFSurveyQuickAccessWidget = publicWidget.Widget.extend({
    ...
    */
    ...
    _submitCode: function () {
        ...
        this._rpc({
            route: `/of_survey/check_session_code/${sessionCodeInputVal}`,
...
return publicWidget.registry.OFSurveyQuickAccessWidget;
