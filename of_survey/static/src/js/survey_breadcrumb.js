odoo.define('of_survey.breadcrumb', function (require) {
'use strict';

var publicWidget = require('web.public.widget');

publicWidget.registry.OFSurveyBreadcrumbWidget = publicWidget.Widget.extend({
    template: "of_survey.survey_breadcrumb_template",
    events: {
...
return publicWidget.registry.OFSurveyBreadcrumbWidget;
