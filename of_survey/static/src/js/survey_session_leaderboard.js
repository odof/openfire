odoo.define('of_survey.session_leaderboard', function (require) {
'use strict';

var publicWidget = require('web.public.widget');
var SESSION_CHART_COLORS = require('of_survey.session_colors');

publicWidget.registry.OFSurveySessionLeaderboard = publicWidget.Widget.extend({
    ...
    showLeaderboard: function (fadeOut, isScoredQuestion) {
        ...
        var leaderboardPromise = this._rpc({
            route: _.str.sprintf('/of_survey/session/leaderboard/%s', this.surveyAccessToken)
        });
...
return publicWidget.registry.OFSurveySessionLeaderboard;
