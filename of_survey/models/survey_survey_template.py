...
class OFSurveyTemplate(models.Model):
                        ...
                        (
                            ...
                            {  # survey.question
                                ...
                                'suggested_answer_ids': [
                                    (0, 0, {'value': _('Often (1-3 times per week)')}),  # survey.question.answer
                                    (0, 0, {'value': _('Rarely (1-3 times per month)')}),  # survey.question.answer
                                    (0, 0, {'value': _('Never (less than once a month)')}),  # survey.question.answer
                                ],
                            },
                        ),
                        (
    ...
    def action_load_sample_certification(self):
            ...
            'question_and_page_ids': [
                ...
                (
                    ...
                    {  # survey.question
                        ...
                        'question_type': 'simple_choice',
                        'suggested_answer_ids': [
                            (0, 0, {'value': _('It\'s a Belgian word for "Management"')}),  # survey.question.answer
                            (0, 0, {'value': _('Object-Directed Open Organization')}),  # survey.question.answer
                            (
                                0,
                                0,
                ...
                (
                    ...
                    {  # survey.question
                        ...
                        'suggested_answer_ids': [
                            ...
                            (0, 0, {'value': _('One needs to get 50% of the total score')}),  # survey.question.answer
                            (
                                0,
                                0,
                                {  # survey.question.answer
        ...
        mail_template = self.env.ref('of_survey.mail_template_certification', raise_if_not_found=False)
        if mail_template:
                    ...
                    'question_and_page_ids': [
                        ...
                        (
                            ...
                            {  # survey.question
                                ...
                                'question_type': 'simple_choice',
                                'suggested_answer_ids': [
                                    (0, 0, {'value': _('Practice in front of a mirror')}),  # survey.question.answer
                                    (
                                        0,
                                        0,
                                        {  # survey.question.answer
                                    ...
                                    (0, 0, {'value': _('Use humor and make jokes')}),  # survey.question.answer
                                ],
                            },
                        ),
                        (
    ...
    def action_show_sample(self):
        action = self.env['ir.actions.act_window']._for_xml_id('of_survey.action_survey_form')
        action['views'] = [[self.env.ref('of_survey.survey_survey_view_form').id, 'form']]
