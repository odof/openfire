...
class ProjectIssue(models.Model):
    ...
    def _search_of_parc_installe_site_adresse(self, operator, value):
        ...
        if value == '' and operator == '=':
            ...
            cr.execute(
                ...
                "  AND of_parc_installe.id = project_issue.of_produit_installe_id",
    ...
    product_category_id = fields.Many2one(
        ...
        string=u"Famille",
        related='product_name_id.categ_id',
        readonly=True,
        store=True,
    )
    ...
    of_parc_installe_site_city = fields.Char(string=u"Ville", related='of_produit_installe_id.site_adresse_id.city')
    of_parc_installe_site_adresse = fields.Char(
        string=u"Adresse d'installation",
        related='of_produit_installe_id.site_adresse_id.contact_address',
        search='_search_of_parc_installe_site_adresse',
        readonly=True,
    )
