odoo.define('of.account.payment.payment', function (require) {
"use strict";
    ...
    render_value: function() {
        ...
        if (info !== false) {
            ...
            this.$('.outstanding_credit_assign').click(function(){
                ...
                new Model("account.payment")
                    .call("assign_outstanding_credit", [payment_id, id])
            ...
            _.each(this.$('.js_payment_info'), function(k, v){
                var options = {
                    'content': QWeb.render('OFPaymentReconcilePopOver', {
                    ...
                    $(this).parent().find('.js_unreconcile_payment').click(function(){
                        ...
                        if (payment_id !== undefined && payment_id !== NaN){
                            new Model("account.move.line")
                                .call("remove_move_reconcile", [payment_id, {'payment_id': self.view.datarecord.id}])
                                .then(function (result) {
                                    self.view.reload();
                                });
                        }
...
core.form_widget_registry.add('of_payment_payment', ShowPaymentLineWidget);
