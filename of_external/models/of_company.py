...
class ResCompany(models.Model):
    ...
    of_custom_footer_line_3 = fields.Char(string='line 3')
    ...
    of_custom_footer_line_3_size = fields.Selection([('medium', 'Medium'), ('small', 'Small'), ('smaller', 'Smaller'), ('x-small', 'X-Small')], string='Size', default='smaller', required=True)
