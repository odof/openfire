...
class OFDatastorePurchase(models.Model):
    ...
    dropshipping = fields.Selection(selection=[
        ...
        help=u"Placeholder : doit expliquer comment la sélection est réalisée.")
    # help=u"Peut être forcé en sélectionnant la valeur inverse de la valeur calculée. Pour revenir à une valeur calculée, vider le champ")
