...
class StockRule(models.Model):
    ...
    def _prepare_purchase_order(self, partner):
        res = super(StockRule, self)._prepare_purchase_order(partner)
        ...
        res["delivery_expected"] = sale_order.of_delivery_expected
    ...
    #                 body=(
    #                     _("No vendor associated to product %s. Please set one to fix this procurement.")
    ...
    #                 "<a href=# data-oe-model=procurement.order data-oe-id=%d>%s</a>"
    #             ) % (procurement.id, name)
    ...
    #             message = _(
    #                 "This purchase order has been modified from: "
    #                 "<a href=# data-oe-model=procurement.order data-oe-id=%d>%s</a>"
    #             ) % (procurement.id, name)
    #             po.message_post(body=message)
    #         if po:
    ...
    #         po_line = False
    #         separate_lines = (
    #             self.env["ir.values"].sudo().get_default("purchase.config.settings", "of_description_as_order_setting")
    #         )
    #         if not separate_lines:
    #             for line in po.order_line:
    #                 if (
    #                     line.product_id == procurement.product_id
