...
class OfProductBrand(models.Model):
    ...
    product_change_warn = fields.Boolean(compute="_compute_product_change_warning")
    ...
    def _compute_product_change_warning(self):
...
#     @api.onchange('use_prefix')
#     def _onchange_use_prefix(self):
#         if isinstance(self.id, int):
#             use_prefix_changed = self.product_ids and self.use_prefix != self.read(['use_prefix'])['use_prefix'] or False
#             return {'context': dict(self.context, use_prefix_changed=use_prefix_changed)}
    ...
    def update_products_default_code(self, products=False, remove_previous_prefix=False):
        ...
        @type products: browse records of product.product or False
...
class ProductTemplate(models.Model):
    ...
    def _onchange_brand_id(self):
        ...
        self.brand_id.update_products_default_code(products=self.product_variant_ids, remove_previous_prefix=self.of_previous_brand_id.code)
