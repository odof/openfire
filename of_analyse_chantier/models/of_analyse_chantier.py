...
class OfAnalyseChantierInherit(models.AbstractModel):
    ...
    @api.depends('order_line_ids', 'invoice_line_ids')
    ...
    def _get_values_from_invoice_lines(self):
        return {
            'order_line_ids' : [(6, 0, self.invoice_line_ids.mapped('of_order_line_ids')._ids)],
...
class OfAnalyseChantierLine(models.AbstractModel):
    ...
    purchase_price_compute = fields.Float(string=u"Coût total", compute="_compute_purchase_price", inverse="_inverse_purchase_price")
    purchase_price = fields.Float(string=u"Coût total")
    margin = fields.Float(string="Marge", compute="compute_marge")
    margin_pc = fields.Float(string="Marge (%)", compute="compute_marge")
...
class OfAnalyseChantier(models.Model):
    ...
    cout_produit_total = fields.Float(string="Coût total produits", compute="_compute_produit")
    cout_produit = fields.Float(string="Coût des produits", compute="_compute_produit")
    cout_produit_additionnels = fields.Float(string="Coût des produits additionnels", compute="_compute_produit")
    vente_produit_total = fields.Float(string="Vente total produits", compute="_compute_produit")
    vente_produit = fields.Float(string="Vente des produits", compute="_compute_produit")
    vente_produit_additionnels = fields.Float(string="Vente des produits additionnels", compute="_compute_produit")

    cout_service_total = fields.Float(string="Coût total services", compute="_compute_service")
    cout_service = fields.Float(string="Coût des services", compute="_compute_service")
    cout_service_additionnels = fields.Float(string="Coût des services additionnels", compute="_compute_service")
    vente_service_total = fields.Float(string="Vente total services", compute="_compute_service")
    vente_service = fields.Float(string="Vente des services", compute="_compute_service")
    vente_service_additionnels = fields.Float(string="Vente des services additionnels", compute="_compute_service")

    marge_brute = fields.Float(string="Marge brute", compute="_compute_marge")
    marge_brute_pc = fields.Float(string="Marge brute (%)", compute="_compute_marge")
    marge_semi_nette = fields.Float(string="Marge semi-nette", compute="_compute_marge")
    marge_semi_nette_pc = fields.Float(string="Marge semi-nette (%)", compute="_compute_marge")
    marge_nette = fields.Float(string="Marge nette", compute="_compute_marge")
    marge_nette_pc = fields.Float(string="Marge nette (%)", compute="_compute_marge")
    ...
    def _compute_marge(self):
        for analyse in self:
            ...
            if sold != 0 and cost != 0:
                ...
                marge_semi_nette = sold - cost - sum(analyse.intervention_ids.mapped('cout_moyen_theorique'))
                analyse.marge_semi_nette = marge_semi_nette
                analyse.marge_semi_nette_pc = marge_semi_nette * 100 / sold
                marge_nette = sold - cost - sum(analyse.intervention_ids.mapped('cout_theorique'))
