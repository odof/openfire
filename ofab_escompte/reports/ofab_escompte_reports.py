...
class AccountInvoice(models.Model):
    ...
    def _compute_of_invoice_line_escompte_ids(self):
        for invoice in self:
            invoice.of_invoice_line_escompte_ids = invoice.invoice_line_ids.filtered(lambda line: line.of_type_escompte)
            invoice.of_invoice_line_sans_escompte_ids = invoice.invoice_line_ids - invoice.of_invoice_line_escompte_ids
